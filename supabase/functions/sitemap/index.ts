...
const STATIC_URLS: Array<{ path: string; changefreq?: string; priority?: string }> = [
  ...
  { path: "/klachten", changefreq: "yearly", priority: "0.3" },
  { path: "/cookies", changefreq: "yearly", priority: "0.3" },
  { path: "/social-media", changefreq: "weekly", priority: "0.4" },
  { path: "/mijn-zp/certificaat", changefreq: "monthly", priority: "0.6" },
  { path: "/mijn-zp/pauzeren", changefreq: "monthly", priority: "0.6" },
  { path: "/mijn-zp/documenten", changefreq: "monthly", priority: "0.6" },
];
