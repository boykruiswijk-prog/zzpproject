...
const services = [
  {
    ...
    icon: Shield,
    title: "Verzekeringen",
    subtitle: "Bescherming voor jou en je onderneming",
    description: "Als zelfstandig professional ben je zelf verantwoordelijk voor je zakelijke zekerheid. Wij helpen je met de juiste verzekeringen via onze partners, voor de scherpste prijs van Nederland.",
    features: [
