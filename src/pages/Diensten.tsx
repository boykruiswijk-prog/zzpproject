...
const services = [
  ...
  { id: "financiering", icon: Banknote, title: "Factoring & Financiering", subtitle: "Snelle uitbetaling, geen cashflow-zorgen", description: "Wacht niet meer weken op betaling van je facturen. Via ZP Zaken Factoring ontvang je binnen 24 uur je geld, 7 dagen per week. Volledig geautomatiseerd, met debiteurenbeheer en faillissementsrisico afgedekt. Wij regelen dit direct voor jou :  zonder externe partij.", features: ["⚡ Uitbetaling binnen 24 uur", "Geautomatiseerde facturering", "Debiteurenbeheer uitbesteed", "Faillissementsrisico afgedekt", "SEPA-brede ondersteuning", "Realtime financieel dashboard"], forWho: "ZZP'ers die snel over hun geld willen beschikken", cta: "Start met factoring", href: "/contact", partners: ["ZP Zaken Factoring"], backgroundImage: officeMeetingRoom },
];
  ...
  return (
    <Layout>
      <SEOHead
        ...
        description="Onze diensten voor zelfstandig professionals. Van verzekeringen en screening tot juridisch advies en factoring. Persoonlijk advies, geen callcenter."
      >
      ...
      {services.map((service, index) => (
        <div key={service.id}>
          ...
          {service.id === "verzekeringen" && (
            <section className="bg-background py-16 lg:py-20 border-y border-border/50">
              <div className="container-wide">
                <motion.div
                ...
                >
                  <div className="flex items-center justify-between gap-3 mb-4">
                    ...
                    <span className="inline-flex items-center gap-1.5 bg-muted text-muted-foreground px-3 py-1 rounded-full text-xs font-medium">
                      Binnenkort beschikbaar
                    </span>
                  </div>
                  <h3 className="text-2xl md:text-3xl mb-3">SharePeople</h3>
                  <p className="text-muted-foreground mb-6 leading-relaxed">
                    SharePeople biedt een collectieve arbeidsongeschiktheidsverzekering speciaal voor zelfstandigen. Via ZP Zaken krijg je toegang tot deze collectieve AOV met aantrekkelijke voorwaarden.
                  </p>
                  <div className="flex flex-wrap gap-2 mb-6">
                    {["Collectieve AOV", "Speciaal voor zelfstandigen", "Via ZP Zaken"].map((feat) => (
