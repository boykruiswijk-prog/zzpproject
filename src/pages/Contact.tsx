            ...
            <div className="space-y-6">
              <div className="bg-card rounded-2xl p-8 shadow-card border border-border/50">
                ...
                <div className="space-y-4">
                  ...
                  <a href="https://wa.me/31204573077" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 text-muted-foreground hover:text-foreground transition-colors">
                    ...
                    <div><p className="font-medium text-foreground">020 - 457 3077</p><p className="text-sm">WhatsApp ons</p></div>
                  </a>
