  ...
  return (
    <Layout>
      ...
      <PageHero
        ...
        badge={{ icon: <Share2 className="h-4 w-4" />, text: "Volg ons" }}
      ...
      >
        <div className="flex flex-wrap gap-4">
          ...
          <Button size="lg" variant="outline" className="bg-background/10 text-primary-foreground border-primary-foreground/30 hover:bg-background/20" asChild>
            <a href="https://www.instagram.com/zp_zaken/" target="_blank" rel="noopener noreferrer">
              Volg ons op Instagram <ExternalLink className="h-4 w-4" />
            </a>
          </Button>
          <Button size="lg" variant="outline" className="bg-background/10 text-primary-foreground border-primary-foreground/30 hover:bg-background/20" asChild>
      ...
      {/* 3. Platforms - LinkedIn & Instagram */}
        ...
        <div className="container-wide">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <h2 className="mb-4">Volg ons op <span className="text-primary">LinkedIn</span></h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="lg:order-2">
              <div className="inline-flex items-center gap-2 bg-[#E4405F]/10 border border-[#E4405F]/20 text-[#E4405F] px-4 py-2 rounded-full mb-6">
              ...
              <h2 className="mb-4">Volg ons op <span className="text-primary">Instagram</span></h2>
              <p className="text-lg text-muted-foreground mb-6">
                Op Instagram geven we een kijkje achter de schermen bij ZP Zaken en delen we visuele content over ondernemen, verzekeringen en het zzp-leven.
              </p>
              <ul className="space-y-3 mb-8">
                <li className="flex items-start gap-3 text-muted-foreground">
                  <CheckCircle className="h-5 w-5 text-accent flex-shrink-0 mt-0.5" />
                  <span>Kijkje achter de schermen bij ons team</span>
                </li>
                <li className="flex items-start gap-3 text-muted-foreground">
                  <CheckCircle className="h-5 w-5 text-accent flex-shrink-0 mt-0.5" />
                  <span>Tips en infographics over zzp-verzekeringen</span>
                </li>
                <li className="flex items-start gap-3 text-muted-foreground">
                  <CheckCircle className="h-5 w-5 text-accent flex-shrink-0 mt-0.5" />
                  <span>Stories over het dagelijks leven als ondernemer</span>
                </li>
                <li className="flex items-start gap-3 text-muted-foreground">
                  <CheckCircle className="h-5 w-5 text-accent flex-shrink-0 mt-0.5" />
                  <span>Reels met korte uitleg over aansprakelijkheid en risico's</span>
                </li>
              </ul>
              <Button variant="accent" size="lg" asChild>
                <a href="https://www.instagram.com/zp_zaken/" target="_blank" rel="noopener noreferrer">
            ...
            <div className="bg-card border border-border/50 rounded-2xl p-8 shadow-card lg:order-1">
              <div className="flex items-center gap-3 mb-4">
                <div className="h-12 w-12 bg-gradient-to-br from-[#F58529] via-[#DD2A7B] to-[#8134AF] rounded-lg flex items-center justify-center">
              ...
              <p className="text-muted-foreground mb-6">
                Volg ons op Instagram voor een kijkje achter de schermen bij ZP Zaken.
              </p>
              <Button variant="accent" asChild>
                <a href="https://www.instagram.com/zpzaken" target="_blank" rel="noopener noreferrer">
                  Volg ons op Instagram <ArrowRight className="h-4 w-4" />
                </a>
              </Button>
              <p className="mt-4 text-xs text-muted-foreground/70">
                Live social media integratie volgt na livegang van de site.
