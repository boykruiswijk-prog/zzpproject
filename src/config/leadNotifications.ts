...
export const LEAD_NOTIFICATIONS: Record<LeadType, LeadNotificationConfig> = {
  ...
  "mijn-zp-certificaat": {
    recipient: "info@zpzaken.nl",
    ccUser: true,
    subjectTemplate: (ref) => `Nieuwe polis-aanvraag via zpzaken.nl - ${ref}`,
    label: "Polis-aanvraag",
  },
  "mijn-zp-opzeggen": {
    recipient: "info@zpzaken.nl",
    ccUser: true,
    subjectTemplate: (ref) => `Nieuwe opzegging via zpzaken.nl - ${ref}`,
    label: "Opzegging",
  },
  "mijn-zp-pauzeren": {
    recipient: "info@zpzaken.nl",
  ...
  "offerte-aanvraag": {
    recipient: "info@zpzaken.nl",
    ccUser: true,
    subjectTemplate: (ref) => `Nieuwe offerteaanvraag via zpzaken.nl - ${ref}`,
